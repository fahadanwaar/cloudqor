...
export const projects: Project[] = [
  {
    ...
    summary:
      "Lift-and-shift of legacy workloads with IaC, zero-downtime cutover, and cost optimization.",
    tags: ["AWS", "Terraform", "SRE"],
    image: "/images/projects/multi-cloud-migration/cover.jpg",
    link: "/marketing/portfolio/multi-cloud-migration",
    status: "active",
  },
  {
    ...
    summary:
      "Streaming pipeline + dashboard for KPIs across regions; sub-2s latency.",
    tags: ["GCP", "BigQuery", "Next.js"],
    image: "/images/projects/realtime-analytics-dashboard/cover.jpg",
    link: "/marketing/portfolio/realtime-analytics-dashboard",
    status: "planned",
  },
  {
    ...
    summary:
      "Security posture review, CI/CD hardening, and policy-as-code with OPA.",
    tags: ["Security", "OPA", "CI/CD"],
    image: "/images/projects/fintech-platform-hardening/cover.jpg",
    link: "/marketing/portfolio/fintech-platform-hardening",
    status: "archived",
  },
  {
  ...
  {
    id: "p9",
    title: "CASH Agility — Lean-Agile Consulting Website",
    summary:
      "French-language consulting site showcasing CASH Agility’s Lean-Agile services, enterprise coaching, and lead-generation CTAs.",
    tags: ["Next.js", "React", "TypeScript", "Tailwind", "Marketing Site"],
    image: "/images/projects/cash-agility/cover.jpg", // apna actual path yahan
    link: "/marketing/portfolio/cash-agility",
    status: "active",
  },
];
